--Rescuer of Melirria - Hitomi Ishihara
local s,id=GetID()
...
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(tp,s.thfilter,tp,LOCATION_GRAVE,0,1,1,nil) 
		and Duel.IsPlayerCanSendtoDeck(tp,nil,1,REASON_EFFECT)~=0 end
